    ...
    <div class="container">
        <section class="card">
            <header class="form-header">
                <div>
                    <h1 class="form-title">Add Ink</h1>
            ...
            <form action="{{route('inventory.create_ink')}}" method="POST">
                @csrf
                @method('post')
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Stock</label>
                        <input type="number" name="ink_stock" class="input" placeholder="Ink Stock" min="0" required>
                    </div>
                    <div class="form-group">
                        <label>Reorder level</label>
                        <input type="number" name="reorder_level" class="input" placeholder="Reoder Level" min="1" required>
                    </div>
